...
def init_db():
    ...
    if Feed.query.count() == 0:
        for feed in [ \
                ...
                Feed(uri='https://readwrite.com/feed/', name='Readwrite', category='All News'),
                Feed(uri='https://rss.nytimes.com/services/xml/rss/nyt/Technology.xml', name='NYT', category='Technology'),
                Feed(uri='https://stringer.sdxcentral.com/rss/sdxcentral-news-feed.rss', name='SDxCentral', category='News'),
                ...
                Feed(uri='https://www.ft.com/companies?format=rss', name='FT', category='Companies'),
                Feed(uri='https://www.ft.com/entrepreneurship?format=rss', name='FT', category='Entrepreneurship'),
                Feed(uri='https://www.ft.com/technology?format=rss', name='FT', category='Technology'),
                ...
                Feed(uri='https://www.theregister.com/headlines.atom', name='TheRegister', category='Headlines'),
